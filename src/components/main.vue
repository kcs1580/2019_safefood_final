                ...
                <img v-show="fade[0]" key="0" class="im" src="../../public/food.jpg">
                    <img v-show="fade[1]" key="1" class="im" src="../../public/food2.jpg">
                        <img v-show="fade[2]" key="2" class="im" src="../../public/food3.jpg">
                            ...
                            <nav class="navbar">
                                <!-- <a class="nav_btn1" href="http://localhost:8090">홈으로</a> <router-link
                                class="nav_btn1" to="/listNotice">공지사항</router-link> | <router-link
                                class="nav_btn1" to="/productlist">상품정보</router-link> | <router-link
                                class="nav_btn1" to="/mytakeinfo">섭취정보</router-link> | <router-link
                                class="nav_btn1" to="/listBoard">질문게시판</router-link> | <router-link
                                class="nav_btn1" to="/signuppage">회원가입</router-link> | <button
                                @click="modal_recommend " type="button">오늘 뭐먹징?</button> -->
